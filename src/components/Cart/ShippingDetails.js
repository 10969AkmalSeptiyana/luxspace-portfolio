        ...
        <form onSubmit={fnSubmit}>
                ...
                ? Array(2)
                    ...
                    .map((_, index) => (
                      <div className="px-2 h-24 mb-4 w-6/12" key={index}>
                        <div className="bg-gray-300 w-full animate-pulse rounded-lg mx-2"></div>
                      </div>
                    ))
                    ...
                    <div className="px-2 w-6/12 h-24 mb-4" key={item.id}>
                      ...
                      >
                        <img
                          src={item.imgUrl}
                          alt={item.name}
                          className="object-contain mx-h-full"
                        />
                      </button>
                    </div>
                  ))}
          ...
          <div className="text-center">
            <button
              ...
              className="bg-pink-400 text-black hover:bg-black hover:text-pink-400 focus:outline-none w-full py-3 rounded-full"
            >
              Checkout Now
            </button>
          </div>
