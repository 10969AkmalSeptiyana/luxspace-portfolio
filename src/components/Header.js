  ...
  return (
    <header className={[position, "w-full z-40 px-4"].join(" ")}>
      <div className="container mx-auto py-5">
        <nav className="flex flex-stretch items-center">
          <div className="w-56 items-center flex">
            <Link to="/">
              <img
                src="/images/logo.png"
                alt="Luxpsace | Fulfill your house with beautiful furniture"
              />
            </Link>
          </div>
          ...
          <div className="w-auto">
            <ul
              className={[
                "fixed bg-white inset-0 flex-col items-center justify-center md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center",
                toggleMainMenu
          ...
          <div className="w-auto">
            <ul className="flex items-center">
              <li className="ml-6 block md:hidden">
                <button
                  className={[
                    "flex z-50 items-center w-8 h-8 text-black md:text-white focus:outline-none",
